...
import { Brain, Plus, Crown, ArrowUp } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-blue-700 dark:text-blue-300 mb-4">
                  You've reached your current plan's deck creation limit.
                  Upgrade to continue creating unlimited flashcard decks and
      ...
      {!hasPermission && !isLoading && (
        <AccessRestricted feature="deck creation" />
      )}
    </div>
  );
};

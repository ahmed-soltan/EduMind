          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  Upload your notes, textbooks, or lectures and let our AI
                  summarize, explain, and answer your questions instantly. Say
                  goodbye to endless hours of studying and hello to smarter
                  learning.
                </TextEffect>
                <AnimatedGroup
                  variants={{
                ...
                >
                  <div
                    key={1}
                    className="bg-blue-400 rounded-md border p-0.5 w-full max-w-[300px]"
                  >
                    <GetStartedButton
                      asChild
                      size="lg"
                      className="rounded-md px-5 text-base w-full"
                    >
